...
const TRANSLATIONS = {
  en: {
    ...
    'idx.edu.1.desc':   'Currently in my first year of the ICT program at the University of Applied Science and Technology (UNASAT). Building a strong foundation in information technology, programming, networking, and digital systems, while applying real-world experience from my professional background.',
    'idx.edu.1.stat':   'First Year — In Progress',
    'idx.edu.2.deg':    'Schakeljaar — Accountancy',
    'idx.edu.2.sch':    'Anton de Kom Universiteit van Suriname (ADEK)',
    'idx.edu.2.desc':   'Completed a bridging year (schakeljaar) in Accountancy at Anton de Kom Universiteit van Suriname. This year strengthened my academic and analytical foundation and prepared me for higher education in ICT.',
    'idx.edu.2.stat':   'Completed',
    'idx.edu.3.deg':    'Secondary Education',
    'idx.edu.3.sch':    'Mr. Dr. J.C. de Miranda Lyceum (Lyco1)',
    'idx.edu.3.desc':   'Attended Mr. Dr. J.C. de Miranda Lyceum for five years, building the academic and analytical skills that laid the groundwork for my future studies in technology.',
    ...
    'idx.exp.1.co':     'AfzalTransport — Paramaribo, Suriname',
    'idx.exp.1.desc':   'Worked in a management role at AfzalTransport, overseeing day-to-day operations and coordinating logistics activities. Responsible for planning, team coordination, and ensuring smooth operational workflows within the organisation.',
    ...
    'idx.exp.3.co':     'Francisco Infra N.V. — Paramaribo, Suriname',
    'idx.exp.3.desc':   'Currently working in a management role at Francisco Infra N.V. alongside my ICT studies at UNASAT. Applying strong organisational and leadership skills while continuing to grow my technical knowledge in the field of information technology.',
    ...
    'abt.edu.1.desc': 'Currently in my first year of the ICT program at the University of Applied Science and Technology (UNASAT). Building a strong foundation in information technology, programming, networking, and digital systems, while applying real-world experience from my professional background.',
    'abt.edu.1.stat': 'First Year — In Progress',
    'abt.edu.2.deg':  'Schakeljaar — Accountancy',
    'abt.edu.2.sch':  'Anton de Kom Universiteit van Suriname (ADEK)',
    'abt.edu.2.desc': 'Completed a bridging year (schakeljaar) in Accountancy at Anton de Kom Universiteit van Suriname. This year strengthened my academic and analytical foundation and prepared me for higher education in ICT.',
    'abt.edu.2.stat': 'Completed',
    'abt.edu.3.deg':  'Secondary Education',
    'abt.edu.3.sch':  'Mr. Dr. J.C. de Miranda Lyceum (Lyco1)',
    'abt.edu.3.desc': 'Attended Mr. Dr. J.C. de Miranda Lyceum for five years, building the academic and analytical skills that laid the groundwork for my future studies in technology.',
    ...
    'abt.exp.1.co':   'AfzalTransport — Paramaribo, Suriname',
    'abt.exp.1.desc': 'Worked in a management role at AfzalTransport, overseeing day-to-day operations and coordinating logistics activities. Responsible for planning, team coordination, and ensuring smooth operational workflows within the organisation. Also built an internal website for the company using HTML, CSS, and JavaScript.',
    ...
    'abt.exp.3.co':   'Francisco Infra N.V. — Paramaribo, Suriname',
    'abt.exp.3.desc': 'Currently working in a management role at Francisco Infra N.V. alongside my ICT studies at UNASAT. Applying strong organisational and leadership skills while continuing to grow my technical knowledge in the field of information technology.',
    ...
    'wrk.hero.title': 'My <span class="gradient-text">Projects</span>',
    'wrk.hero.sub':   "Real projects I've built — from company websites to full-stack games.",
    'wrk.p1.badge':   'Internal',
    'wrk.p1.type':    'Internal Web Development · 2024',
    'wrk.p1.title':   'AfzalTransport Admin Site',
    'wrk.p1.desc':    'Built an internal admin site for AfzalTransport to manage day-to-day operations and streamline internal workflows. Developed during my management role at the company using core web technologies.',
    'wrk.p1.locked':  'Internal — Not Public',
    'wrk.p2.badge':   'Live',
    'wrk.p2.type':    'Web Development · 2024',
    'wrk.p2.title':   'AfzalTransport Website',
    'wrk.p2.desc':    "Designed and built the public-facing website for AfzalTransport, a transport company based in Paramaribo, Suriname. The site serves as the company's online presence and is live at afzaltransport.sr.",
    'wrk.p2.live':    'Visit Site',
    'wrk.p3.badge':   'Private',
    'wrk.p3.type':    'Game Development · 2025',
    'wrk.p3.title':   'SuriQuest 2060',
    'wrk.p3.desc':    'A full-stack educational game set in Suriname in the year 2060. Built with React, Phaser 3, Express, and MySQL — featuring user authentication, a game engine, and a backend API. A project that blends storytelling with technology.',
    'wrk.p3.locked':  'Private — Not Public',
    'wrk.p4.badge':   'Live',
    'wrk.p4.type':    'Personal Project · 2025',
    'wrk.p4.title':   'Portfolio Website',
    'wrk.p4.desc':    "My personal developer portfolio — the site you're looking at right now. Built from scratch with a focus on clean design, smooth animations, and bilingual support in English and Dutch.",
    'wrk.p4.here':    "You're here",
  ...
  nl: {
    ...
    'idx.edu.1.sch':    'UNASAT — Paramaribo, Suriname',
    'idx.edu.1.desc':   'Momenteel in mijn eerste jaar van het ICT-programma aan de University of Applied Science and Technology (UNASAT). Ik bouw een sterke basis in informatietechnologie, programmeren, netwerken en digitale systemen, terwijl ik praktijkervaring toepas vanuit mijn professionele achtergrond.',
    'idx.edu.1.stat':   'Eerste Jaar — Bezig',
    'idx.edu.2.deg':    'Schakeljaar — Accountancy',
    'idx.edu.2.sch':    'Anton de Kom Universiteit van Suriname (ADEK)',
    'idx.edu.2.desc':   'Schakeljaar Accountancy afgerond aan de Anton de Kom Universiteit van Suriname. Dit jaar versterkte mijn academische en analytische basis en bereidde me voor op een hogere opleiding in ICT.',
    'idx.edu.2.stat':   'Afgerond',
    'idx.edu.3.deg':    'Middelbaar Onderwijs',
    'idx.edu.3.sch':    'Mr. Dr. J.C. de Miranda Lyceum (Lyco1)',
    'idx.edu.3.desc':   'Vijf jaar lang het Mr. Dr. J.C. de Miranda Lyceum gevolgd, waarbij ik de academische en analytische vaardigheden heb opgebouwd die de basis legden voor mijn toekomstige studie in technologie.',
    ...
    'idx.exp.1.role':   'Management',
    'idx.exp.1.co':     'AfzalTransport — Paramaribo, Suriname',
    'idx.exp.1.desc':   'Werkzaam in een managementfunctie bij AfzalTransport, verantwoordelijk voor dagelijkse operaties en het coördineren van logistieke activiteiten. Verantwoordelijk voor planning, teamcoördinatie en het waarborgen van soepele operationele workflows binnen de organisatie.',
    'idx.exp.2.role':   'Management',
    'idx.exp.2.co':     'Adesh — Paramaribo, Suriname',
    ...
    'idx.exp.3.role':   'Management',
    'idx.exp.3.co':     'Francisco Infra N.V. — Paramaribo, Suriname',
    'idx.exp.3.desc':   'Momenteel werkzaam in een managementfunctie bij Francisco Infra N.V. naast mijn ICT-studie aan de UNASAT. Sterke organisatorische en leiderschapsvaardigheden toepassen terwijl ik mijn technische kennis op het gebied van informatietechnologie blijf uitbreiden.',
    ...
    'abt.edu.1.sch':  'UNASAT — Paramaribo, Suriname',
    'abt.edu.1.desc': 'Momenteel in mijn eerste jaar van het ICT-programma aan de University of Applied Science and Technology (UNASAT). Ik bouw een sterke basis in informatietechnologie, programmeren, netwerken en digitale systemen, terwijl ik praktijkervaring toepas vanuit mijn professionele achtergrond.',
    'abt.edu.1.stat': 'Eerste Jaar — Bezig',
    'abt.edu.2.deg':  'Schakeljaar — Accountancy',
    'abt.edu.2.sch':  'Anton de Kom Universiteit van Suriname (ADEK)',
    'abt.edu.2.desc': 'Schakeljaar Accountancy afgerond aan de Anton de Kom Universiteit van Suriname. Dit jaar versterkte mijn academische en analytische basis en bereidde me voor op een hogere opleiding in ICT.',
    'abt.edu.2.stat': 'Afgerond',
    'abt.edu.3.deg':  'Middelbaar Onderwijs',
    'abt.edu.3.sch':  'Mr. Dr. J.C. de Miranda Lyceum (Lyco1)',
    'abt.edu.3.desc': 'Vijf jaar lang het Mr. Dr. J.C. de Miranda Lyceum gevolgd, waarbij ik de academische en analytische vaardigheden heb opgebouwd die de basis legden voor mijn toekomstige studie in technologie.',
    ...
    'abt.exp.1.role': 'Management',
    'abt.exp.1.co':   'AfzalTransport — Paramaribo, Suriname',
    'abt.exp.1.desc': 'Werkzaam in een managementfunctie bij AfzalTransport, verantwoordelijk voor dagelijkse operaties en het coördineren van logistieke activiteiten. Ook een interne website gebouwd voor het bedrijf met HTML, CSS en JavaScript.',
    'abt.exp.2.role': 'Management',
    'abt.exp.2.co':   'Adesh — Paramaribo, Suriname',
    ...
    'abt.exp.3.role': 'Management',
    'abt.exp.3.co':   'Francisco Infra N.V. — Paramaribo, Suriname',
    'abt.exp.3.desc': 'Momenteel werkzaam in een managementfunctie bij Francisco Infra N.V. naast mijn ICT-studie aan de UNASAT. Sterke organisatorische en leiderschapsvaardigheden toepassen terwijl ik mijn technische kennis blijf uitbreiden.',
    ...
    /* ══ WORK PAGE ══ */
    'wrk.hero.tag':   'Portfolio',
    'wrk.hero.title': 'Mijn <span class="gradient-text">Projecten</span>',
    'wrk.hero.sub':   'Echte projecten die ik heb gebouwd — van bedrijfswebsites tot full-stack games.',
    'wrk.p1.badge':   'Intern',
    'wrk.p1.type':    'Interne Webontwikkeling · 2024',
    'wrk.p1.title':   'AfzalTransport Beheerpaneel',
    'wrk.p1.desc':    'Een intern beheerpaneel gebouwd voor AfzalTransport om dagelijkse operaties te beheren en interne workflows te stroomlijnen. Ontwikkeld tijdens mijn managementfunctie bij het bedrijf met kerntechnologieën voor het web.',
    'wrk.p1.locked':  'Intern — Niet Openbaar',
    'wrk.p2.badge':   'Live',
    'wrk.p2.type':    'Webontwikkeling · 2024',
    'wrk.p2.title':   'AfzalTransport Website',
    'wrk.p2.desc':    'De publieke website ontworpen en gebouwd voor AfzalTransport, een transportbedrijf in Paramaribo, Suriname. De site dient als online aanwezigheid van het bedrijf en is live op afzaltransport.sr.',
    'wrk.p2.live':    'Bezoek Site',
    'wrk.p3.badge':   'Privé',
    'wrk.p3.type':    'Spelontwikkeling · 2025',
    'wrk.p3.title':   'SuriQuest 2060',
    'wrk.p3.desc':    'Een full-stack educatief spel gesitueerd in Suriname in het jaar 2060. Gebouwd met React, Phaser 3, Express en MySQL — met gebruikersauthenticatie, een game-engine en een backend-API. Een project dat verhalen vertellen combineert met technologie.',
    'wrk.p3.locked':  'Privé — Niet Openbaar',
    'wrk.p4.badge':   'Live',
    'wrk.p4.type':    'Persoonlijk Project · 2025',
    'wrk.p4.title':   'Portfolio Website',
    'wrk.p4.desc':    'Mijn persoonlijke ontwikkelaarsportfolio — de site die je nu bekijkt. Vanaf nul gebouwd met focus op strak design, vloeiende animaties en tweetalige ondersteuning in Engels en Nederlands.',
    'wrk.p4.here':    'Je bent hier',
